...
document.getElementById('dive').addEventListener('click', (event) => {
    event.stopPropagation(); // Ensure button click works without interference from joystick
...
function update() {
    // Optional: Update joystick values or display status if needed
